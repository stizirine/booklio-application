  ...
  return (
    <div className="relative min-h-screen bg-[var(--color-bg)] overflow-hidden">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -right-16 -top-10 h-48 w-48 rounded-full bg-gradient-to-br from-[var(--color-secondary)]/18 to-[var(--color-primary)]/10 blur-3xl" />
        <div className="absolute left-0 bottom-0 h-56 w-56 rounded-full bg-gradient-to-br from-[var(--color-primary)]/14 to-[var(--color-secondary)]/10 blur-3xl" />
      </div>

      <div className="relative min-h-screen px-4 py-8 sm:px-6 lg:px-8 flex items-center justify-center">
        <div className="w-full max-w-md space-y-6 mx-auto">
          <div className="space-y-2 text-center sm:text-left">
            <p className="text-sm sm:text-base font-semibold uppercase tracking-wide text-[var(--color-secondary)]">{t('auth.register')}</p>
